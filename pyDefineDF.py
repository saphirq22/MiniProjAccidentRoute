...
pathCa = "C:/Users/saphi/OneDrive/Documents/miniProjPy/data2022/carcteristiques-2022.csv"
pathLi = "C:/Users/saphi/OneDrive/Documents/miniProjPy/data2022/lieux-2022.csv"
pathUs = "C:/Users/saphi/OneDrive/Documents/miniProjPy/data2022/usagers-2022.csv"
pathVh = "C:/Users/saphi/OneDrive/Documents/miniProjPy/data2022/vehicules-2022.csv"
pathPo = "C:/Users/saphi/OneDrive/Documents/miniProjPy/data2022/Departements.csv"

laFranceEntiere = ['01','02','03','04','05','06','07','08','09',
...
def DefineDF(maRegion):
    ...
    dfCaLi = dfCa.merge(dfLi, left_on=['Num_Acc'], right_on =['Num_Acc'] )
...
def DefineDFus(maRegion):
    ...
    df = df.merge(dfCa, left_on=["Num_Acc"], right_on =['Num_Acc'] )
    df = df[df.dep.isin(maRegion)]
